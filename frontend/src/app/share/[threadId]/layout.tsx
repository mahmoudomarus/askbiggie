...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Bignoodle AI',
    description: 'Replay this Agent conversation on Bignoodle AI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Bignoodle AI';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Bignoodle AI';
