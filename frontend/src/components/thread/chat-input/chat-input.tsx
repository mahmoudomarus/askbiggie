  ...
  (
    ...
    useEffect(() => {
      if (typeof window !== 'undefined' && onAgentSelect && !hasLoadedFromLocalStorage.current) {
        ...
        if (!selectedAgentId && !hasAgentIdInUrl) {
          ...
          if (savedAgentId) {
                    // Convert 'biggie' back to undefined for the default agent
        const agentIdToSelect = savedAgentId === 'biggie' ? undefined : savedAgentId;
    ...
    useEffect(() => {
      if (typeof window !== 'undefined') {
        // Use 'biggie' as a special key for the default agent (undefined)
        const keyToStore = selectedAgentId === undefined ? 'biggie' : selectedAgentId;
