...
from agent.tools.data_providers.CryptoProvider import CryptoProvider
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "service_name": {
                        "type": "string",
                        "description": "The name of the data provider (e.g., 'linkedin', 'twitter', 'zillow', 'amazon', 'yahoo_finance', 'crypto')"
                    }
                },
