...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'dom@bignoodle.ai')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Biggie Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Biggie — Let's Get Started "
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Welcome to Bignoodle AI</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix-suna-logo.png" alt="Bignoodle AI Logo" class="logo">
    </div>
          <h1>Welcome to Bignoodle AI!</h1>

    <p>Hi {user_name},</p>

            <p><em><strong>Welcome to Bignoodle AI — we're excited to have you on board!</strong></em></p>
    ...
    <p><strong>For your business:</strong> if you want to automate manual and ordinary tasks for your company, book a call with us <a href="https://cal.com/team/kortix/enterprise-demo">here</a></p>
            ...
            <p>Thanks again, and welcome to the Biggie community <span class="emoji">🌞</span></p>

            <p>— The Biggie Team</p>

            <a href="https://askbiggie.ai/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Biggie — we're excited to have you on board!
...
Thanks again, and welcome to the Biggie community 🌞

— The Biggie Team

Go to the platform: https://askbiggie.ai/

---
© 2024 Biggie. All rights reserved.
You received this email because you signed up for a Biggie account."""
